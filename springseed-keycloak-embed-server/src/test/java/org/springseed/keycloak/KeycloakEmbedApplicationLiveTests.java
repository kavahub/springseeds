...
public class KeycloakEmbedApplicationLiveTests {
    ...
    public static final String AUTHORIZE_CODE_URL = "http://localhost:9000/auth/realms/springseeds/protocol/openid-connect/auth?response_type=code&client_id=client1&scope=read&redirect_uri=";
    public static final String TOKEN_URL = "http://localhost:9000/auth/realms/springseeds/protocol/openid-connect/token";
    public static final String INTROSPECT_URL = "http://localhost:9000/auth/realms/springseeds/protocol/openid-connect/token/introspect";
    public static final String USER_INFO_URL = "http://localhost:9000/auth/realms/springseeds/protocol/openid-connect/userinfo";

    public static final String JWT_CLIENT_SECRET = "TySuFI8m8NPyOMhxSjF1Q9pb8TRMBPra";
    public static final String JWT_CLIENT = "client1";
    public static final String REDIRECT_URL = "http://localhost:4200/";

    public static final String USERNAME = "zhangs";
    public static final String PASSWORD = "123";
    public static final String OIDC_DISCOVERY_URL = "http://localhost:9000/auth/realms/springseeds/.well-known/openid-configuration";
    ...
    public void givenRefreshTokenGrantAndValidRefreshToken_whenObtainAccess_thenSuccess() {
        ...
        final String tokenUrl = "http://localhost:9000/auth/realms/springseeds/protocol/openid-connect/token";
        ...
        Response response = RestAssured
                ...
                .header("Authorization",
                        String.format("Basic %s",
                                new String(
                                        Base64.getEncoder().encode((JWT_CLIENT + ":" + JWT_CLIENT_SECRET).getBytes()))))
